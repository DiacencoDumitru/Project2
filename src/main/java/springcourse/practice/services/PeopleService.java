...
public class PeopleService {
    ...
    // если человек есть возвращаем человека иначе null
    ...
    public List<Book> getBooksByPersonId(int id) {
        ...
        if (person.isPresent()) {
            ...
            // Мы внизу итерируемся по книгам, поэтому они точно будут загружены, но на всякий случай не мешает всегда вызывать Hibernate.initialize()
